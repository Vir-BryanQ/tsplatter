...
class GaussianModel:
    ...
    def get_thermal_features(self):
        thermal_features_dc = self._thermal_features_dc
        thermal_features_rest = self._thermal_features_rest
        return torch.cat((thermal_features_dc[:, None, :], thermal_features_rest), dim=1)
